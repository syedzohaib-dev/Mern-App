import {
  ...
  require_warning,
  useCol
} from "./chunk-KEWCGNVD.js";
import {
  Container_default
} from "./chunk-H6H7TSC5.js";
import {
  ModalBody_default,
  ModalDialog_default,
  ModalFooter_default,
...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-6QDRTIOY.js";
import {
  CardImg_default,
  Card_default
} from "./chunk-LWUACEOI.js";
import "./chunk-5IMEWZKW.js";
import {
  divWithClassName_default
} from "./chunk-ITFWC7TF.js";
import {
  createWithBsPrefix
} from "./chunk-Z5LC6WFN.js";
import {
  FloatingLabel_default,
  FormGroup_default
} from "./chunk-W4S6SDPS.js";
import {
  require_react_dom
} from "./chunk-OCHDJWGW.js";
import {
  Button_default as Button_default2
} from "./chunk-ZW347ZYJ.js";
import {
  Button_default
} from "./chunk-6KDVHA5R.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Carousel = React16.forwardRef(({
  ...
  return (0, import_jsx_runtime16.jsxs)(Component2, {
    ref: elementRef,
    ...props,
...
function DropdownMenu(_ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(import_jsx_runtime18.Fragment, {
...
var DropdownItem = React20.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime22.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime23.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime23.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
var Dropdown2 = React27.forwardRef((pProps, ref) => {
  ...
  return (0, import_jsx_runtime27.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime27.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime27.jsx)(Component2, {
        ...props,
        ref,
...
var DropdownButton = React28.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime29.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime28.jsx)(DropdownToggle_default2, {
    id,
    href,
    size,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime28.jsx)(DropdownMenu_default2, {
    role: menuRole,
...
var Image = React29.forwardRef(({
  ...
  return (0, import_jsx_runtime30.jsx)("img", {
...
var FigureImage = React30.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime31.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime32.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime32.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime32.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime32.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime32.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime32.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames21.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroup = React33.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime34.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
var NavDropdown = React34.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime36.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames24.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime35.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime35.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React35.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react24.useState)(!props.show);
...
var Popover = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime38.jsxs)("div", {
    ...
    className: (0, import_classnames25.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Tooltip = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime40.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames26.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react25.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React39.forwardRef(({
  ...
  const popperRef = (0, import_react26.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react26.useState)(null);
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react27.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react27.useRef)("");
  ...
  const handleHide = (0, import_react27.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react27.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react27.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react27.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react27.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react27.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime44.jsxs)(import_jsx_runtime43.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react27.cloneElement)(children, triggerProps), (0, import_jsx_runtime42.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime45.jsx)("li", {
    ...
    children: (0, import_jsx_runtime46.jsxs)(Component2, {
      className: (0, import_classnames28.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime47.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames29.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames30.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React43.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime48.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var ProgressBar = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react28.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Spinner = React48.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
  ...
  return (0, import_jsx_runtime53.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames34.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React49.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  children: [(0, import_jsx_runtime54.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime54.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
...
var Stack = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime56.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames35.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react29.useContext)(TabContext_default);
  if (!context4)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react30.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react30.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime62.jsx)(import_jsx_runtime61.Fragment, {});
};
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime65.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime64.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
...
var ToastFade = React58.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React59.createContext({
...
var ToastHeader = React60.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react31.useContext)(ToastContext_default);
  ...
  return (0, import_jsx_runtime68.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames38.default)(bsPrefix, className),
...
var Toast = React61.forwardRef(({
  ...
  const delayRef = (0, import_react32.useRef)(delay);
  ...
  const autohideFunc = (0, import_react32.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react32.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  const toast = (0, import_jsx_runtime69.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames39.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames40.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var ToggleButton = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime72.Fragment, {
    children: [(0, import_jsx_runtime71.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames41.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
