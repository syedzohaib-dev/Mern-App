...
function ProductModal() {
    ...
    const handleShow = () => {
        axios.get('localhost:3100/api/get-all-brands')
            .then((json) => {
                setBrands(json.data.brands)
                axios.get('localhost:3100/api/get-all-categories').then((json) => {
            ...
            .then(() => {
                ...
                uploadBytes(storageRef, ProductThumbnail).then((snapshot) => {
                    getDownloadURL(snapshot.ref).then((thumbnailurl) => {
                        ...
                        axios.post('localhost:3100/api/create-product', payload).then((json) => {
